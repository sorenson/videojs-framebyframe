...
var VjsButton=videojs.getComponent("Button"),FBFButton=videojs.extend(VjsButton,{constructor:function(t,e){VjsButton.call(this,t,e),this.player=t,this.frameTime=1/e.fps,this.step_size=e.value,this.on("click",this.onClick)},onClick:function(){this.player.pause();var t=this.frameTime*this.step_size;this.player.currentTime(this.player.currentTime()+t)}});function framebyframe(e){var s=this;s.ready(function(){e.steps.forEach(function(t){s.controlBar.addChild(new FBFButton(s,{el:videojs.dom.createEl("button",{className:"vjs-res-button vjs-control",innerHTML:'<div class="vjs-control-content" style="font-size: 11px; line-height: 28px;"><span class="vjs-fbf">'+t.text+"</span></div>"},{role:"button"}),value:t.step,fps:e.fps}),{},t.index)})})}videojs.registerPlugin("framebyframe",framebyframe);